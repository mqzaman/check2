...
//$strvalue=str_replace('contenteditable="true"','contenteditable="false"',$_POST['quilltxt']);
//$strvalue=str_replace('<input type="text" data-formula="e=mc^2" data-link="https://qsysbd.com" data-video="Embed URL">','',$strvalue);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>Full Editor - Quill Rich Text Editor First time with multi</title>
  <meta charset="utf-8">
